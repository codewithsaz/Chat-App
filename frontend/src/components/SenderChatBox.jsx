...
const SenderChatBox = ({ messageText, mediaURL, messageTime }) => {
  return (
    <div className="w-full flex items-center justify-end px-4 py-2">
      <div className="w-auto min-w-[10rem] flex flex-col max-w-xs md:max-w-xl rounded-l-xl rounded-tr-xl px-2 py-1 bg-zinc-200 dark:bg-zinc-700">
        <h6 className="w-full font-semibold break-words">You</h6>
        {mediaURL && (
          <Image
